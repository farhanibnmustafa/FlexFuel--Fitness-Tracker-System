(function () {
  ...
  const WORKOUT_SEED_WEEKS = {
    'Lose Weight': {
      Beginner: {
        Mon: {
          workouts: [
            { exercise: 'Jumping Jacks', prescription: '3x30s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            ...
            { exercise: 'Plank', prescription: '3x25s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' }
          ],
          baseBurn: 320
        },
        Tue: {
          workouts: [
            ...
            { exercise: 'Forward Lunges', prescription: '3x10/leg', video: 'https://www.youtube.com/watch?v=_PQm64POLOk' },
            { exercise: 'Glute Bridges', prescription: '3x15', video: 'https://www.youtube.com/watch?v=wPM8icPu6H8' },
            { exercise: 'Side Plank', prescription: '3x20s/side', video: 'https://www.youtube.com/watch?v=UrAUan4fPYE' }
          ],
          baseBurn: 300
        },
        Wed: {
        ...
        Thu: {
          workouts: [
            ...
            { exercise: 'Burpees', prescription: '3x8', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
        ...
        Fri: {
          workouts: [
            { exercise: 'Crunches', prescription: '3x18', video: 'https://www.youtube.com/watch?v=EAyx9zvSTfc' },
      ...
      Intermediate: {
        Mon: {
          workouts: [
            { exercise: 'Jumping Jacks', prescription: '4x35s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
        ...
        Tue: {
          workouts: [
            ...
            { exercise: 'Forward Lunges', prescription: '4x12/leg', video: 'https://www.youtube.com/watch?v=_PQm64POLOk' },
            { exercise: 'Glute Bridges', prescription: '4x18', video: 'https://www.youtube.com/watch?v=wPM8icPu6H8' },
            { exercise: 'Side Plank', prescription: '3x30s/side', video: 'https://www.youtube.com/watch?v=UrAUan4fPYE' }
          ],
          baseBurn: 345
        },
        Wed: {
        ...
        Fri: {
          workouts: [
            { exercise: 'Crunches', prescription: '4x20', video: 'https://www.youtube.com/watch?v=EAyx9zvSTfc' },
      ...
      Advanced: {
        Mon: {
          workouts: [
            { exercise: 'Jumping Jacks', prescription: '5x40s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            ...
            { exercise: 'Plank', prescription: '3x45s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' }
          ],
          baseBurn: 416
        },
        Tue: {
          workouts: [
            ...
            { exercise: 'Forward Lunges', prescription: '4x14/leg', video: 'https://www.youtube.com/watch?v=_PQm64POLOk' },
            { exercise: 'Glute Bridges', prescription: '4x20', video: 'https://www.youtube.com/watch?v=wPM8icPu6H8' },
            { exercise: 'Side Plank', prescription: '3x40s/side', video: 'https://www.youtube.com/watch?v=UrAUan4fPYE' }
          ],
          baseBurn: 390
        },
        Wed: {
        ...
        Thu: {
          workouts: [
            ...
            { exercise: 'Burpees', prescription: '4x10', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
        ...
        Fri: {
          workouts: [
            { exercise: 'Crunches', prescription: '4x24', video: 'https://www.youtube.com/watch?v=EAyx9zvSTfc' },
    ...
    'Build Muscle': {
      Beginner: {
        ...
        Tue: {
          workouts: [
            { exercise: 'Lunges', prescription: '4x10/leg', video: 'https://www.youtube.com/watch?v=YZbyE7U6Gos' },
            { exercise: 'Glute Bridges', prescription: '4x18', video: 'https://www.youtube.com/watch?v=wPM8icPu6H8' },
        ...
        Thu: {
          workouts: [
            ...
            { exercise: 'Tricep Dips', prescription: '3x12', video: 'https://www.youtube.com/watch?v=zFCMz1NkwQo' },
        ...
        Fri: {
          workouts: [
            { exercise: 'Pull-ups', prescription: '3x6', video: 'https://www.youtube.com/watch?v=eGo4IYlbE5g' },
            { exercise: 'Calf Raises', prescription: '3x18', video: 'https://www.youtube.com/watch?v=-M4-G8p8fmc' },
            { exercise: 'Squats', prescription: '3x18', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 330
        },
        Sat: {
      ...
      Intermediate: {
        Mon: {
          workouts: [
            ...
            { exercise: 'Squats', prescription: '4x22', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' },
        ...
        Fri: {
          workouts: [
            { exercise: 'Pull-ups', prescription: '3x8', video: 'https://www.youtube.com/watch?v=eGo4IYlbE5g' },
            { exercise: 'Calf Raises', prescription: '4x20', video: 'https://www.youtube.com/watch?v=-M4-G8p8fmc' },
            { exercise: 'Squats', prescription: '4x20', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 380
        },
        Sat: {
      ...
      Advanced: {
        Mon: {
          workouts: [
            ...
            { exercise: 'Squats', prescription: '5x22', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' },
        ...
        Tue: {
          workouts: [
            { exercise: 'Lunges', prescription: '5x12/leg', video: 'https://www.youtube.com/watch?v=YZbyE7U6Gos' },
        ...
        Thu: {
          workouts: [
            ...
            { exercise: 'Tricep Dips', prescription: '4x14', video: 'https://www.youtube.com/watch?v=zFCMz1NkwQo' },
            { exercise: 'Mountain Climbers', prescription: '4x40s', video: 'https://www.youtube.com/watch?v=nmwgirgXLYM' }
          ],
          baseBurn: 405
        },
        Fri: {
          workouts: [
            ...
            { exercise: 'Squats', prescription: '4x24', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 430
        },
        Sat: {
      ...
      Beginner: {
        ...
        Wed: {
          workouts: [
            ...
            { exercise: 'Jumping Jacks', prescription: '4x25s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' }
          ],
          baseBurn: 320
        },
        Thu: {
        ...
        Sat: {
          workouts: [
            { exercise: 'Burpees', prescription: '3x10', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
            { exercise: 'Jumping Jacks', prescription: '3x25s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            { exercise: 'Squats', prescription: '3x18', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 360
        },
      ...
      Intermediate: {
        ...
        Wed: {
          workouts: [
            ...
            { exercise: 'Jumping Jacks', prescription: '5x30s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' }
          ],
          baseBurn: 360
        },
        Thu: {
        ...
        Sat: {
          workouts: [
            { exercise: 'Burpees', prescription: '4x12', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
            { exercise: 'Jumping Jacks', prescription: '4x30s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            { exercise: 'Squats', prescription: '4x20', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 410
        },
      ...
      Advanced: {
        Mon: {
          workouts: [
            ...
            { exercise: 'Burpees', prescription: '5x12', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
            { exercise: 'Mountain Climbers', prescription: '4x40s', video: 'https://www.youtube.com/watch?v=nmwgirgXLYM' },
            { exercise: 'Plank', prescription: '3x60s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' }
          ],
          baseBurn: 470
        },
        Tue: {
        ...
        Wed: {
          workouts: [
            ...
            { exercise: 'Jumping Jacks', prescription: '6x35s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' }
          ],
          baseBurn: 400
        },
        Thu: {
        ...
        Sat: {
          workouts: [
            { exercise: 'Burpees', prescription: '5x12', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
            { exercise: 'Jumping Jacks', prescription: '5x35s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            { exercise: 'Squats', prescription: '5x22', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 470
        },
    ...
    'General Fitness': {
      Beginner: {
        Mon: {
          workouts: [
            { exercise: 'Jumping Jacks', prescription: '3x30s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            { exercise: 'Push-ups', prescription: '3x10', video: 'https://www.youtube.com/watch?v=_l3ySVKYVJ8' },
            { exercise: 'Squats', prescription: '3x15', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' },
            { exercise: 'Plank', prescription: '3x30s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' }
          ],
          baseBurn: 300
        },
        Tue: {
        ...
        Wed: {
          workouts: [
            { exercise: 'Plank', prescription: '3x40s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' },
            { exercise: 'Bird-dog', prescription: '3x12/side', video: 'https://www.youtube.com/watch?v=wiFNA3sqjCA' },
            { exercise: 'Squats', prescription: '3x18', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 260
        ...
        Fri: {
          workouts: [
            { exercise: 'Lunges', prescription: '3x12/leg', video: 'https://www.youtube.com/watch?v=YZbyE7U6Gos' },
      ...
      Intermediate: {
        ...
        Wed: {
          workouts: [
            { exercise: 'Plank', prescription: '4x40s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' },
      ...
      Advanced: {
        ...
        Wed: {
          workouts: [
            { exercise: 'Plank', prescription: '4x60s', video: 'https://www.youtube.com/watch?v=dnERKMqkd3k' },
            { exercise: 'Bird-dog', prescription: '4x15/side', video: 'https://www.youtube.com/watch?v=wiFNA3sqjCA' },
            { exercise: 'Squats', prescription: '4x24', video: 'https://www.youtube.com/watch?v=601fB5fQvjE' }
          ],
          baseBurn: 320
        ...
        Thu: {
          workouts: [
            { exercise: 'Burpees', prescription: '5x10', video: 'https://www.youtube.com/watch?v=EmXaVk2k0GM' },
            { exercise: 'Jumping Jacks', prescription: '5x40s', video: 'https://www.youtube.com/watch?v=RO_iZNEB9IU' },
            { exercise: 'Push-ups', prescription: '5x15', video: 'https://www.youtube.com/watch?v=_l3ySVKYVJ8' }
          ],
          baseBurn: 390
        ...
        Fri: {
          workouts: [
            { exercise: 'Lunges', prescription: '5x14/leg', video: 'https://www.youtube.com/watch?v=YZbyE7U6Gos' },
  ...
  const WORKOUT_METADATA = {
    ...
    'mountain-climbers': { categories: ['cardio', 'shoulders'], tags: ['hiit'] },
    ...
    'incline-push-up': { categories: ['chest', 'arms'], tags: ['upper-body'] },
    'wide-push-up': { categories: ['chest', 'arms'], tags: ['upper-body'] },
    'close-grip-push-up': { categories: ['arms', 'chest'], tags: ['triceps'] },
    'bicep-curl': { categories: ['arms'], tags: ['biceps'] },
    'concentration-curl': { categories: ['arms'], tags: ['biceps'] },
    'side-lunge': { categories: ['legs'], tags: ['glutes', 'lower-body'] },
    'hollow-body-hold': { categories: ['core'], tags: ['abs', 'stability'] },
    'sit-up': { categories: ['core'], tags: ['abs'] },
